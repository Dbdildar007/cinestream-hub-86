    ...
    >
      ...
      {!videoEnded && !showRecommendations && recommendedMovies.length > 0 && showControls && !isLocked && (
        <button
          ...
          className="absolute bottom-20 left-1/2 -translate-x-1/2 z-[106] flex items-center gap-1 px-3 py-1.5 rounded-full bg-white/40 backdrop-blur-sm text-white/90 text-xs font-light hover:bg-white/50 transition-colors"
        >
