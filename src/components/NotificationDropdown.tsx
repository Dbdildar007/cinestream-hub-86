...
import { Bell, CheckCheck, X, UserPlus, Film, Phone, UserCheck } from "lucide-react";
            ...
            <>
              ...
              <motion.div
                ...
                className={`absolute z-50 bg-card border border-border rounded-xl shadow-2xl overflow-hidden ${
                  isMobile
                    ? "bottom-full mb-2 right-1/2 translate-x-1/2 w-[calc(100vw-2rem)] max-w-[360px] max-h-[70vh]"
              ...
              >
                ...
                {/* Notifications list */}
                <div className={`overflow-y-auto ${isMobile ? "max-h-[60vh]" : "max-h-[400px]"}`}>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {actionable && (
                              <div className="flex gap-2 mt-2">
                                ...
                                <button
                                  onClick={(e) => { e.stopPropagation(); setDeclineTarget(notif); }}
